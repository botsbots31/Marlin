...
#define STRING_CONFIG_H_AUTHOR "(6/3/2023, Erik Farley SKR3 Bear)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR3 Bear"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 40.15
  #define DEFAULT_bedKi 1.68
  #define DEFAULT_bedKd 638.06
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {198.67, 162.26, 800, 415.23 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 15, 80 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.42}
